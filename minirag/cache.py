...
class EmbeddingCache:
    ...
    def get_cached_docs(self, docs_path: str, model_name: str) -> Optional[List[Document]]:
    ...
    def save_embedded_docs(self, docs_path: str, model_name: str, embedded_docs: List[Document]) -> None:
